...
typedef const GLubyte* gluErrorString_hack;
gluErrorString_hack APIENTRY gluErrorString (
    GLenum   errCode);

typedef const wchar_t* gluErrorUnicodeStringEXT_hack;
gluErrorUnicodeStringEXT_hack APIENTRY gluErrorUnicodeStringEXT (
    GLenum   errCode);

typedef const GLubyte* gluGetString_hack;
gluGetString_hack APIENTRY gluGetString (
    GLenum   name);
...
typedef GLUquadric* gluNewQuadric_hack;
gluNewQuadric_hack APIENTRY gluNewQuadric (void);
...
typedef void CALLBACK (*gluQuadricCallback_hack)();
void APIENTRY gluQuadricCallback (
    GLUquadric          *qobj, 
    GLenum              which, 
    gluQuadricCallback_hack fn );
/*    void                (CALLBACK* fn)());*/

typedef GLUtesselator* gluNewTess_hack;
gluNewTess_hack APIENTRY  gluNewTess(
    void );
...
typedef void CALLBACK (*gluTessCallback_hack)();
void APIENTRY  gluTessCallback(     
    GLUtesselator       *tess,
    GLenum              which, 
    gluTessCallback_hack fn );
...
typedef GLUnurbs* gluNewNurbsRenderer_hack;
gluNewNurbsRenderer_hack APIENTRY gluNewNurbsRenderer (void);
...
typedef void CALLBACK (*gluNurbsCallback_hack)();
void APIENTRY 
gluNurbsCallback (
    GLUnurbs            *nobj, 
    GLenum              which, 
    gluNurbsCallback_hack fn );
...
                                                                                                                                                                                                 ameraPos);
	...
	{
		if ( (nWidth < AI_EPSILON) || (nHeight < AI_EPSILON) || (farPlane - nearPlane < AI_EPSILON) ) return;
